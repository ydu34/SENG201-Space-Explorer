...
public class MainWindow {
	...
	private void initialize() {
		...
		frmSpaceExplorers.getContentPane().setFont(new Font("L M Mono Prop Lt10", Font.PLAIN, 12));
		...
		frmSpaceExplorers.getContentPane().add(lblPlanetName);
		
		JLabel lblDay = new JLabel("Day:");
		lblDay.setFont(new Font("Dialog", Font.BOLD, 20));
		lblDay.setBounds(616, 106, 170, 35);
		frmSpaceExplorers.getContentPane().add(lblDay);
		...
		frmSpaceExplorers.getContentPane().add(lblPiecesFound);
		...
		frmSpaceExplorers.getContentPane().add(btnOutpost);
		...
		frmSpaceExplorers.getContentPane().add(lblShieldLevel);
		...
		frmSpaceExplorers.getContentPane().add(lblDayValue);
		...
		frmSpaceExplorers.getContentPane().add(lblPiecesFoundValue);
		...
		frmSpaceExplorers.getContentPane().add(lblShipName);
		...
		frmSpaceExplorers.getContentPane().add(lblShipLevelValue);
	}
}
