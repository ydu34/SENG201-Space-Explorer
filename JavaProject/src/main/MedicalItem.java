...
public class MedicalItem extends Item {
	 ...
	 * @param restoreHealthAmount An int of restore health amount when the medical
	 *                            item is consumed.
	 * @param removePlague        A boolean expression of whether the medical item
	 *                            is a cure to the space plague.
	 */
	 ...
	 * 
	 * @return True if the medical item is the cure to the space plague, false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @param removePlague A boolean expression of whether the medical item is a
	 *                     cure to the space plague.
	 */
